      ...
      <Dialog/>
        ...
        <table
          ...
          style={{ textAlign: "center"}}
             > 
              {watchM.map((el) => <HomeCardm id={el.id} name={el.name} seria={el.seria} description={el.description} /> )}
        ...
        <table
          ...
          style={{ textAlign: "center"}}
        >
         {watchW.map((el) => <HomeCardw id={el.id} name={el.name} seria={el.seria} description={el.description} /> )}
